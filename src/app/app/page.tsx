    ...
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Your sustainability evaluation workspace.</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          {
            label: 'Drafts',
            value: evaluations.length - completedCount - inProgressCount,
                ...
                <Card key={ev.id} hover className="flex items-center gap-4">
                  ...
                  {summary && (
                    <div className="hidden md:flex items-center gap-6 text-xs">
                      ...
                      <div className="text-center">
                        <div
                          className={`font-bold ${summary.riskOverallLabel === 'Critical' ? 'text-red-600' : summary.riskOverallLabel === 'Severe' ? 'text-orange-600' : 'text-amber-600'}`}
                        >
                  ...
                  <Link
                    href={
                      ev.status === 'completed'
                        ? `/app/evaluate/${ev.id}/dashboard`
                        : `/app/evaluate/${ev.id}/summary`
                    }
      ...
      <Card accent className="bg-brand/5 border-l-brand">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          This tool helps you design sustainability into your startup from the start. Complete Stage
          I to identify material topics, then Stage II to map your risk and opportunity landscape.
          Your SDG Alignment and Dashboard will follow automatically.
        </p>
      </Card>
    </div>
  );
