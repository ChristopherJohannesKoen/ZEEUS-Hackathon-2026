  ...
  if (variant === "mark") {
    ...
    return (
      ...
      >
        ...
        <text x="20" y="26" textAnchor="middle" fontFamily="Inter, sans-serif" fontWeight="800" fontSize="18" fill="white">Z</text>
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <svg viewBox="0 0 36 36" fill="none" className="h-9 w-9 flex-shrink-0" aria-hidden="true">
        ...
        <text x="18" y="24" textAnchor="middle" fontFamily="Inter, sans-serif" fontWeight="800" fontSize="16" fill="white">Z</text>
