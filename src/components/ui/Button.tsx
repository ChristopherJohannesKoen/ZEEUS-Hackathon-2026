...
export function Button({
  ...
  const variants: Record<string, string> = {
    ...
    secondary: "bg-white border border-surface-border text-gray-700 shadow-sm hover:bg-surface-muted active:scale-95",
    ...
    "outline-brand": "border border-brand text-brand bg-transparent hover:bg-brand/5 active:scale-95",
  };
