...
export const RISK_DEFINITIONS: RiskDef[] = [
  {
    ...
    description:
      'Exposure to carbon taxes, emission limits, or sustainability reporting mandates that increase costs or constrain operations.',
  ...
  },
  {
    ...
    category: 'Environmental',
    description:
      'Direct operational disruption from extreme weather, flooding, drought, or rising temperatures.',
  ...
  },
  {
    ...
    category: 'Environmental',
    description:
      'Insufficient water availability or quality threatening operations, suppliers, or customers.',
  ...
  },
  {
    ...
    category: 'Environmental',
    description:
      'Business activities near or dependent on sensitive ecosystems face regulatory or reputational exposure.',
  ...
  },
  {
    ...
    category: 'Environmental',
    description:
      'Dependence on scarce, volatile, or single-source materials threatening continuity.',
  ...
  },
  {
    ...
    category: 'Social',
    description:
      'Employee wellbeing, rights violations, or talent retention failures that harm performance.',
  ...
  },
  {
    ...
    category: 'Social',
    description:
      'Labor rights abuses, forced labor, or unsafe conditions in the supply chain triggering legal or reputational harm.',
  ...
  },
  {
    ...
    category: 'Social',
    description:
      'Loss of trust or opposition from affected communities disrupting operations or growth.',
  ...
  },
  {
    ...
    category: 'Social',
    description:
      'Products or services causing harm, litigation, or regulatory action that damages revenue and reputation.',
  ...
  },
  {
    ...
    category: 'Governance',
    description:
      'Weak governance, corruption, or compliance failures that trigger legal, financial, or reputational consequences.',
...
export const OPPORTUNITY_DEFINITIONS: OpportunityDef[] = [
  ...
  },
  {
    ...
    category: 'Social',
    description:
      'Expanding into underserved markets or delivering measurable social value creates strategic differentiation.',
  ...
  },
  {
    ...
    category: 'Governance',
    description:
      'Using technology to enhance transparency, compliance, or sustainability monitoring.',
  ...
  },
  {
    ...
    category: 'Governance',
    description:
      'Credible sustainability reporting builds investor, customer, and partner confidence.',
